...
public class ConnectFour {
	public static void main(String[] args) {
		...
		int row1,col1;
		String y;
		System.out.println("Enter the column and row");
		row1 = in.nextInt();
		col1 = in.nextInt();
		if (row1<=3 || col1<=3) {
			System.out.println("Enter greater than 4, eter the number again");
			row1 = in.nextInt();
			col1 = in.nextInt();
		} 
		char[][] grid = new char[col1][row1];
		...
		System.out.println("Press Y for Play And N for No : ");
		y = in.next();
